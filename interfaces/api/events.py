"""
SAM Interfaces — API — Execution Event Bus (Phase 1, redesigned in Phase 3A)

(Moved here in Phase 3A.5 — originated as iqoo/events.py; iqoo/events.py
now forwards here for backward compatibility.)
...
for, wired up in interfaces/api/server.py. History is not deleted when a stream
