"""
SAM Multimodal — Attachment validation.

(Moved here in Phase 3A.5 — originated as iqoo/media_validation.py
during Phase 2 of the iQOO hackathon branch. Generic image/audio
validation with no iQOO/vivo dependency; iqoo/media_validation.py now
...
# Used by multimodal/audio/adapter.py to pick a sensible temp-file suffix so
