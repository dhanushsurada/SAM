"""
SAM Multimodal — Audio Adapter.

(Moved here in Phase 3A.5 — originated as iqoo/audio_adapter.py during
Phase 2 of the iQOO hackathon branch. Generic audio-transcription
capability with no iQOO/vivo dependency; iqoo/audio_adapter.py now
...
from multimodal.media_validation import AUDIO_MIME_SUFFIX
