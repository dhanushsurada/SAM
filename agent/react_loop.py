...
class ReactLoop:
    ...
    def run_task(self, task: str, brain, session, initial_response=None, cancel_event=None,
        ...
        fired before and after each action. Omit it for the previous
        behaviour. Both callbacks are independent and failure-isolated.
        """
    ...
    def run_planned_task(self, task: str, brain, session, founder_context: str = "",
                          initial_response=None, cancel_event=None, on_step=None,
                          on_event=None) -> str:
        """
